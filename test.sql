...
(2, ' Cab-hailing firm Ola to lThe range of research activities at College of Engineering Trivandrum is broad and deep. CET scholars conduct research in almost every field, and seek to expand human knowledge through analysis, innovation, and insight. Research is supported by more than $800 million of sponsored research funds each year, and it is carried out in all the departments, and at more than 100 research centers, on campus and around the world. Researchers include faculty members, visiting scholars, post-doctoral fellows, and graduate and undergraduate students, and they collaborate with colleagues across the University, at affiliated institutions, and at other research institutions.aunch in the UK ', ' Indian ride-hailing firm Ola said on Tuesday it plans to launch services in the United Kingdom this year, months after it expanded its operations in Australia, in an ongoing turf war with rival Uber Technologies.', '2018-08-04 15:55:38', '2018-08-04 15:55:38'),
