...
describe('EntityParentChild_Association - Get_EntityParentChild_Association GET', () => {
  beforeEach((done) => {
    const entitytype = {
      entity_type: 'people',
  ...
  it('GET /private/entities/entity_parent_child_association/', (done) => {
    chai.request(app)
      .get('/private/entities/entity_parent_child_association/')
      .then((res) => {
