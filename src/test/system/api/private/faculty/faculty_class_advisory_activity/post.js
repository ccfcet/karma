...
describe('Post faculty_advisory_activity - POST', () => {
  beforeEach((done) => {
    const newpeople = {
      first_name: 'John',
      middle_name: 'M',
  ...
  it('POST /private/faculty/faculty_class_advisory_activity/', (done) => {
    const fcaa = {
    ...
    chai.request(app)
      .post('/private/faculty/faculty_class_advisory_activity/')
      .send(fcaa)
      .end((err, result) => {
