...
describe('Faculty_academic_enrolment_activity - GetFacultyAcademicEnrolmentActivity - GET', () => {
    ...
    it('GET /private/faculty/faculty_class_advisory_activity/', (done) => {
        chai.request(app)
        .get('/private/faculty/faculty_class_advisory_activity/')
        .then((res) => {
            ...
            console.log(re)
            expect(re)
            .excluding(['created_at','updated_at']).to.deep.equal(newFCAA);
            done();            
        })
        .catch((err) => {
            done(err);
